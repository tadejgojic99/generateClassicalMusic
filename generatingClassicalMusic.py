...
def getNotes():
    ...
    for dirname, _, filenames in os.walk('/home/tadejgojic/Desktop/generateClassicalMusic/chopinMidi/'):
...
def createNetwork(networkInput, nDiff):
    ...
    #LSTM(Long Short Trem Memory) je sloj RNN koja prima sekvencu ulaza i vraca
